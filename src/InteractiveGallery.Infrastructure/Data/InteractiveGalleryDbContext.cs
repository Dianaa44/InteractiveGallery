...
public class InteractiveGalleryDbContext : IdentityDbContext<ApplicationUser>
{
  public InteractiveGalleryDbContext(DbContextOptions<InteractiveGalleryDbContext> options) : base(options)
  {
  }
  private readonly IDomainEventDispatcher? _dispatcher;

  public InteractiveGalleryDbContext(DbContextOptions options,
